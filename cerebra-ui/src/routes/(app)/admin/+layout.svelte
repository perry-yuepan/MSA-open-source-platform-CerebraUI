    ...
    <nav class="px-2.5 pt-1 backdrop-blur-xl drag-region">
      <div class="flex items-center gap-1">
        ...
        <div class=" flex w-full">
          ...
          >
            <a
              class="min-w-fit rounded-full p-2 {['/admin/users'].includes($page.url.pathname)
                ? ''
            ...
            <a
              class="min-w-fit rounded-full p-2 {$page.url.pathname.includes('/admin/evaluations')
                ? ''
                : 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
            ...
            <a
              class="min-w-fit rounded-full p-2 {$page.url.pathname.includes('/admin/functions')
                ? ''
                : 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition"
