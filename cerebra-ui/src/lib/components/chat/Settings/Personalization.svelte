...
>
	<div class="py-1 overflow-y-scroll max-h-[28rem] lg:max-h-full">
			...
			<div class="flex items-center justify-between mb-1">
				...
				>
					<div class="text-sm font-medium">
						...
						<span class=" text-sm text-gray-500">({$i18n.t('Experimental')})</span>
					</div>
				</Tooltip>
		...
		<div class="mt-3 mb-1 ml-1">
			<button
				type="button"
				class=" px-3.5 py-1.5 font-medium hover:bg-black/5 dark:hover:bg-white/5 outline outline-1 outline-gray-300 dark:outline-gray-800 rounded-lg"
				on:click={() => {
